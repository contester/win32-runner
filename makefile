...
LDFLAGS := -pipe -Wl,--allow-multiple-definition -Wall -g -Os -lws2_32 -L$(BOOST)/lib -Wl,-Bstatic -lboost_date_time-mt -lboost_system-mt -lboost_thread-mt -L$(PROTOBUF)/lib -lprotobuf -L$(RUNLIB32)/src -lrunlib32 -Wl,-Bdynamic -ladvapi32 -lpsapi -luserenv -lmswsock
