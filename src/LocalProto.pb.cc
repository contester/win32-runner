...
void protobuf_AssignDesc_LocalProto_2eproto() {
  protobuf_AddDesc_LocalProto_2eproto();
  ...
  static const int LocalExecutionParameters_offsets_[15] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(LocalExecutionParameters, time_limit_),
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_LocalProto_2eproto);
}
...
void protobuf_AddDesc_LocalProto_2eproto() {
  ...
  ::contester::proto::protobuf_AddDesc_ExecutionProto_2eproto();
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\020LocalProto.proto\022\017contester.proto\032\017Blo"
    "bProto.proto\032\024ExecutionProto.proto\"\230\001\n\020L"
    "ocalEnvironment\022\r\n\005empty\030\001 \001(\010\022<\n\010variab"
    "le\030\002 \003(\0132*.contester.proto.LocalEnvironm"
    ...
    "t\030\005 \001(\004\022\026\n\016check_idleness\030\006 \001(\010\0226\n\013envir"
    "onment\030\007 \001(\0132!.contester.proto.LocalEnvi"
  ...
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_LocalProto_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_LocalProto_2eproto {
  StaticDescriptorInitializer_LocalProto_2eproto() {
    protobuf_AddDesc_LocalProto_2eproto();
  }
} static_descriptor_initializer_LocalProto_2eproto_;
...
const LocalEnvironment_Variable& LocalEnvironment_Variable::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_LocalProto_2eproto();  return *default_instance_;
}
...
const int LocalExecutionParameters::kTimeLimitFieldNumber;
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 3: {
        ...
        if (input->ExpectTag(37)) goto parse_time_limit;
        break;
      }
      ...
      case 14: {
        ...
        if (input->ExpectTag(125)) goto parse_time_limit_hard;
        break;
      }
...
void LocalExecutionParameters::SerializeWithCachedSizes(
  ...
  // optional float time_limit = 4;
  if (_has_bit(3)) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(4, this->time_limit(), output);
  }
  ...
  // optional float time_limit_hard = 15;
  if (_has_bit(10)) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(15, this->time_limit_hard(), output);
  }
...
::google::protobuf::uint8* LocalExecutionParameters::SerializeWithCachedSizesToArray(
  ...
  // optional float time_limit = 4;
  if (_has_bit(3)) {
    target = ::google::protobuf::internal::WireFormatLite::WriteFloatToArray(4, this->time_limit(), target);
  }
  ...
  // optional float time_limit_hard = 15;
  if (_has_bit(10)) {
    target = ::google::protobuf::internal::WireFormatLite::WriteFloatToArray(15, this->time_limit_hard(), target);
  }
